...
//	private String methodColor;
     ...
     *
     * @param classCov  Coverage Information about the Class
     * @param methodCov Coverage Information about the Method
     * @return method name
     */
     ...
     */
    @WebMethod(name = "resources.zip")
    public HttpResponse downloadJacocoResources() {
        String jobInfoDirectory = ((AbstractBuild<?, ?>) action.getOwner()).getRootDir().getAbsolutePath();
        ...
        return HttpResponses.error(404, "File not found.");
    }
